...
(function (exports) {
  ...
  }(typeof exports === 'undefined' ? (self.JSONfn = {}) : exports));



onmessage = function(e) {
  let context = JSONfn.parse(e.data);

  if (context.globals) {
    for (var k in context.globals) { 
      self[k] = context.globals[k]; 
    } 
  }
  
  if (context.run) {
    postMessage(context.run());
  }
}